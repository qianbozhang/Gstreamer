...
int main(int argc, char *argv[]) {
  ...
  g_object_set (data.playbin, "uri", "file:///home/zhangqianbo/GstreamerTest/mediafile/video_subtitle.ogv", NULL);
  ...
  g_object_set (data.playbin, "suburi", "file:///home/zhangqianbo/GstreamerTest/mediafile/title.srt", NULL);
